About clickhouse-odbc-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/clickhouse-odbc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/clickhouse-odbc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2601&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clickhouse-odbc-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add clickhouse-odbc
# for installing globally
pixi global install clickhouse-odbc
```
...
It is possible to list all of the versions of `clickhouse-odbc` available on your platform:
...
```
pixi search clickhouse-odbc --channel conda-forge
```
